...
- [生产部署与运维手册](docs/operations.md)
- [文件与日志管理方案](docs/file-management.md)

> 其余历史 Markdown 文档已合并或迁出，请以以上文件为准。
...
部署、PM2 管理、服务器初始化、备份/清理等内容已统一收录在《[生产部署与运维手册](docs/operations.md)》。请阅读该文档，按实际环境选择直接部署或结合容器、CI/CD 等方式扩展。
